...
export declare namespace cloudtasks_v2beta2 {
    ...
    export class Resource$Projects$Locations$Queues {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        buffer(params: Params$Resource$Projects$Locations$Queues$Buffer, options: StreamMethodOptions): GaxiosPromise<Readable>;
        buffer(params?: Params$Resource$Projects$Locations$Queues$Buffer, options?: MethodOptions): GaxiosPromise<Schema$BufferQueueResponse>;
        buffer(params: Params$Resource$Projects$Locations$Queues$Buffer, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        buffer(params: Params$Resource$Projects$Locations$Queues$Buffer, options: MethodOptions | BodyResponseCallback<Schema$BufferQueueResponse>, callback: BodyResponseCallback<Schema$BufferQueueResponse>): void;
        buffer(params: Params$Resource$Projects$Locations$Queues$Buffer, callback: BodyResponseCallback<Schema$BufferQueueResponse>): void;
    ...
    export interface Params$Resource$Projects$Locations$Queues$Buffer extends StandardParameters {
        /**
         * Required. The queue name. For example: `projects/PROJECT_ID/locations/LOCATION_ID/queues/QUEUE_ID` The queue must already exist.
         */
        name?: string;
